...
# Reshape lại ảnh để chia hết cho 8x8
...
# Đưa tấm ảnh về array (box_size, box_size)
...
# Áp dụng Discrete Cosine Transform trên từng block
...
# Thuật toán run length code (mã hóa entropy)
